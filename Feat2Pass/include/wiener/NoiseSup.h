...
#define NS_EPS                        4.539993e-05f	// (X_FLOAT32)(exp ((double) -10.0))   
#define NS_BETA                       (X_FLOAT32)(0.98)
#define NS_RSB_MIN                    (X_FLOAT32)(0.079432823)
#define NS_LAMBDA_NSE                 (X_FLOAT32)(0.99)
#define NS_SPEC_FLOOR                 4.539993e-05f	// (X_FLOAT32)(exp ((double) -10.0))
...
//#define NS_NB_FRAMES_LATENCY          (X_INT16)(10)//RevByKSH
 ...
 *                                     VAD
 *----------------------------------------------------------------------------*/
#define NS_HANGOVER                   (X_INT16)(30)//(15) org
